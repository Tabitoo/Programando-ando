<?php
  ...
  //Se almacena en una variable el id del usuario al cual se le desea modificar los datos
  $dato=$_POST["id"];
      ...
      <div class="grid-item grid-main">
        <div class="main-content">
           <div class="main-content__caja1">
             <!--Se genera un formulario con los datos del usuario al que querems modificar-->
